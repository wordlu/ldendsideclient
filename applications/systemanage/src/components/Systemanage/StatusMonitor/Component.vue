<template>
  <div class="container">
    ...
    <iframe class="system-monitor" :src="'http://10.86.24.49:30000/d/O_ciWJgHz/device?orgId=1&var-device='+sensorvalue+'&theme=light&kiosk&refresh=5s&from=now-1h&to=now'" frameborder="0"></iframe>
  </div>
</template>
