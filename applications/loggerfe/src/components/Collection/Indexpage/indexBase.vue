...
import { ref, computed, onMounted, onBeforeUnmount, onUnmounted, defineProps } from 'vue';
import { addItem, findAll, findItem, deleteItem } from '@/api/jsonApi'
// import PointView from '@/components/visualization/PointView.vue'
import BasicScene from '@/components/visualization/index/BasicSceneBase.vue'
import DisplayPanel from '@/components/visualization/index/DisplayPanel.vue'
import sensorConfigs from '@/components/visualization/index/sensorConfigsBase.vue'
...
//       props.viewportId = res.data.data[0].id
...
onMounted(() => {
  getCurrentStatus(props.viewportId)
  // queryCurrentDrivers()
  // 建立长连接
